    ...
    <div id="projects" className="flex flex-col items-center min-h-screen py-16 ">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 ">
        {PROJECTS.map((project) => (
          <motion.div
            key={project.id}
            className="relative flex flex-col  items-center p-12 m-5 justify-center border rounded-xl shadow-xl overflow-hidden transition-all duration-500"
            whileHover={{
              scale: 1.03,
              rotateX: 1,
              rotateY: 1,
          ...
          >
            ...
            <h1 className="text-2xltext-center font-extrabold border-b-2 shadow-2xl  px-4 py-2 rounded-full">{project.name}</h1>
