...
const Experiences:React.FC = () => {
  ...
  return (
    ...
    className="pt-20" id="work">
         <h1 className="text-4xl md:text-6xl flex  justify-center  font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 mb-8">Work Experience</h1>
